  ...
  return (
    <div className="rounded-xl border border-black shadow-lg border-solid p-3 m-5 bg-green-500/25">
      <h2 className="text-xl">
        ...
        <button className="text-red-500 float-right hover:text-red-700/10 transition hover:scale-130">
          {" "}
          X{" "}
        </button>
      </h2>
      <div className="rounded-xl border-gray-500/10 border shadow-lg border-solid p-1 m-2 ">
        {" "}
        {}
      </div>
    </div>
