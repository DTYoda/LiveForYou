    ...
    <div className="flex justify-center flex-col md:flex-row">
      ...
      <div className="max-w-2xl w-full">
        <Suspense fallback={<placeholderElements />}>
          {/* {prisma.friends.findMany().then((e) => { console.log(e) })} */}
...
function placeholderElements() {
  return ((<div className="rounded-xl border border-black shadow-lg border-solid p-3 m-5 bg-green-500/25">
    <h2 className="text-xl">
      ...
      <button onClick={processClick} className="text-red-500 float-right hover:text-red-700/10 transition hover:scale-130"> X </button>
    </h2>
